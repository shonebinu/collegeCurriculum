...
6. [Binary Search](./binarySearch.cpp) ([Recursive Implementation](./recursiveBinarySearch.cpp)) [Working](https://www.programiz.com/dsa/binary-search) *The array need to be sorted* 
#### Sorting
